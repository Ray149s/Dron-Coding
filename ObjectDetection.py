...
cv2.createTrackbar("HUE Min","HSV",8,8,empty)
cv2.createTrackbar("HUE Max","HSV",55 ,55 ,empty)
cv2.createTrackbar("SAT Min","HSV",0 , 0,empty)
cv2.createTrackbar("SAT Max","HSV",32,32,empty)
cv2.createTrackbar("VALUE Min","HSV",185,185,empty)
cv2.createTrackbar("VALUE Max","HSV",255,255,empty)

cv2.namedWindow("Parameters")
cv2.resizeWindow("Parameters",640,240)
cv2.createTrackbar("Threshold1","Parameters", 255, 255,empty)
cv2.createTrackbar("Threshold2","Parameters",0,0,empty)
cv2.createTrackbar("Area","Parameters",3000,3000,empty)
